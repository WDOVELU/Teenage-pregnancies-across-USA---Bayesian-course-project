...
for (i in c(1:49))
{
  ...
  for (j in c(0:28))
  {
    integer_rate[i + K*j] <- 10*rate[j+1]
...
# (Intercept) 5.2437 5.2394 5.2478      2120.2        -0.1
# tau2        0.0108 0.0095 0.0121      2000.0        -2.2
# rho.S       0.9859 0.9780 0.9921      2000.0        -1.4
# rho.T       0.9937 0.9810 0.9996      2000.0         1.2
# 
# DIC =  11488.15       p.d =  566.9403       LMPL =  -5645.51 
...
plot(c(c(1990:2018),c(1990:2018),c(1990:2018),c(1990:2018)),
     c(texas$integer_rate/10,texas$texasNA/10,texas$high/10,texas$low/10), 
...
MSE_texas <- MSE(texas$integer_rate/10, texasNA/10)
#  11.56185
...
x11()
plot(c(c(1990:2018),c(1990:2018),c(1990:2018),c(1990:2018)),
     c(missouri$integer_rate/10,missouri$missouriNA/10,missouri$low/10,missouri$high/10), 
     pch = c(rep(19,29*2),rep(3,29*2)),
     col=c(rep("blue",29),rep("red",29*3)), main = 'Real vs sampled Missouri Birth rate values',
     xlab = "Year", ylab="Birth rate")

MSE_missouri <- MSE(missouri_measures$integer_rate/10, missouriNA/10)
#  4.052272
...
x11()
plot(c(c(1990:2018),c(1990:2018),c(1990:2018),c(1990:2018)),
     c(washington$integer_rate/10,washington$washingtonNA/10,washington$low/10,washington$high/10), 
     pch = c(rep(19,29*2),rep(3,29*2)),
     col=c(rep("blue",29),rep("red",29*3)), main = 'Real vs sampled Washington Birth rate values',
     xlab = "Year", ylab="Birth rate")


MSE_washington <- MSE(washington_measures$integer_rate/10, washingtonNA/10)
# 6.25294
...
plot(c(c(1990:2018),c(2016:2018),c(2016:2018),c(2016:2018)),
     c(missouri_measures$integer_rate/10,missouri3$missouriNA/10,missouri3$low/10,missouri3$high/10), 
...
MSE_Missouri_3NA <- MSE(missouri_measures$integer_rate[27:29]/10, missouriNA3/10)
# 0.231346